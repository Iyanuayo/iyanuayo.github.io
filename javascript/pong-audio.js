...
export var wallSound = new soundFile("seagull_flock.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("ship_bells.mp3");
soundArray.push(paddleSound);

export var scoreSound = new soundFile("walking.mp3");
soundArray.push(scoreSound);

export var ambientSound = new soundFile("ocean2.mp3");
soundArray.push(ambientSound);
ambientSound.player.loop = true; //turn on looping
ambientSound.player.volume.value = 35; //turn down volume
